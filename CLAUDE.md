...
- When running `using-engineering-docs`, track which skills have already been completed in the conversation and do not re-run their clarification phases.
...
5. All `🔵 Open Question` items have been flagged - none silently omitted.
